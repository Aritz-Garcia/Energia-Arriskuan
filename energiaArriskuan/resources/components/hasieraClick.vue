<template>
  <div>
    ...
    <div class="absolute top-0 right-0 z-50">
        <Pista :probak=pruebas lugar="hasiera" :partida=partida.id></Pista>
    </div>
    ...
    <div id="letralYnumerosDiv" class="hidden">
      <div id="juego2letralYnumeros"><Cuadro></Cuadro></div>
    </div>
  </div>
</template>
  ...
  data() {
    return {
      objektuak: [
        ...
        // * Numeros y letras pared
        { areaTop: 41, areaLeft: 61.3, areaWidth: 1.4, areaHeight: 6 },
      ],
      testua: "",
    };
  },
      ...
      for (let i = 0; i < this.objektuak.length; i++) {
        ...
        if (
          ...
          if (i == 0) {
            ...
            // * Cuadro
            document.getElementById("letralYnumerosDiv").classList.remove("hidden");
            document.getElementById("letralYnumerosDiv").classList.add("block");
          }
