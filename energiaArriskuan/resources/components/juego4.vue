<template>
    <div>
        ...
        <div class="border-kolore-nagusia border-2 rounded-xl p-4 text-white atzekaldeko-kolore-oinarria w-[880px] mx-auto">
            <div class="flex">
                <div class="flex flex-col items-center mx-5">
                    <div class="relative border-kolore-nagusia border-2 rounded-xl p-5">
                    ...
                    <div class="flex items-center mt-5">
                        <button @click.prevent="decrementarValor" class="border rounded-md border-kolore-nagusia px-3 py-1 m-2">⭠</button>
                        <input type="range" name="brujula" id="brujulaSlider" min="0" max="359" value="0" @input="slideBrujula()" class="accent-[#0BD904]">
                        <button @click.prevent="incrementarValor" class="border rounded-md border-kolore-nagusia px-3 py-1 m-2">⭢</button>
                    </div>
                </div>

                <div class="flex flex-col items-center mx-5">
                    <div class="relative flex justify-between">
                        <div class="border-2 border-kolore-nagusia rounded-xl p-5">
