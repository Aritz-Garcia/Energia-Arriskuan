<template>
    <div class="mt-5">
        <h1  class="text-center text-2xl testu-kolore-nagusia">2. Proba</h1>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            probaBusqueda() {
                return this.proba2Erabiltzaileak().filter(proba => proba.erabiltzailea.includes(this.testua.toLowerCase()));
            },
            utzik() {
