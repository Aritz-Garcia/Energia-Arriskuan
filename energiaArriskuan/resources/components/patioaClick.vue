<template>
  <div>
    ...
    <div id="simbolosDiv" class="hidden">
      <div id="juego2Paperak"><Papera :simbolos="simbolo"></Papera></div>
    </div>
  </div>
</template>
        ...
        if (
          ...
          if (i == 0) {
            ...
            setTimeout(() => {
              ZaborraDiv.classList.remove("block");
              ZaborraDiv.classList.add("hidden");
              ZaborraDiv.classList.remove("animate__ateaItxia__text");
            }, 4900);
          } else if (i == 10) {
            // * kolumpoio
            ...
            setTimeout(() => {
                JolastuDiv.classList.remove("block");
                JolastuDiv.classList.add("hidden");
                JolastuDiv.classList.remove("animate__ateaItxia__text");
            }, 4900);
          }
