<template>
  ...
  <div v-if="confirmacion" class="confirmation-box">
    ...
    <div v-if="abierto" class="modal">
      ...
      <button @click="quitartiempo" class="font-semibold text-[#010440] bg-[#d90404] hover:bg-white hover:text-[#010440] py-2 px-4 rounded-full focus:outline-none">Close</button>
    </div>
    </Teleport>
