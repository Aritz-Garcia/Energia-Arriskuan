...
@section('content')
    ...
    <div
        ...
        <a href="{{ route('erabiltzaileakAdmin', Auth::user()->id) }}"
            class="flex-2/3 card testu-kolore-nagusia hover:text-[#ffffff] atzekaldeko-kolore-oinarria py-5 rounded-3xl border-2 border-kolore-nagusia hover:border-[#ffffff] w-60 min-w-48">
            <div>
