...
@section('content')
    ...
    <div class="containerIndex items-center flex flex-col w-auto py-14 px-16 md:pb-60 md:pt-40">



        <p class="text-xl">
          2073an, baliabide fosilak agortuta, Lurra energia berriztagarrien mende dago. Eraso estralurtarrei aurre egin
          behar diegu, arlo honetan gure ezagutza lapurtu nahian. Txurdinaga LHII zentroari eraso ondoren, sistema guztiak
          deskonektatu ziren, planetako bizitza mehatxatuz. Energia berriztagarrietan aditu den talde batek sistemak
