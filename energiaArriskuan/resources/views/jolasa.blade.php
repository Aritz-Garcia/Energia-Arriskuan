...
@section('content')
    ...
    <div class="contJolasAzalpena relative overflow-hidden testu-kolore-nagusia mt-6">
        ...
        <form action="{{ route('hasiera', $partida->id )}}">
            <button class="absolute top-0 right-0 m-5 my-2 border-2 border-[#0BD904] atzekaldeko-kolore-nagusia testu-kolore-oinarria p-3 px-5 rounded-xl hover:bg-white hover:border-white hover:testu-kolore-oinarria">SKIP</button>
        </form>
    </div>
