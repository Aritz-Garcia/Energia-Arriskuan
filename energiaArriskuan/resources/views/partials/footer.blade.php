<footer class="flex flex-col items-center bg-green-600 text-center text-white dark:bg-green-800">
    ...
    <!--Copyright section-->
    <div class="w-full bg-green-700 p-4 text-center text-green-200 dark:bg-green-800 dark:text-green-400">
