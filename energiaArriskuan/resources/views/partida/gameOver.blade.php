...
@section('content')
    ...
    <div class="w-screen h-screen sotoaPanelLetra gameOver absolute top-1/2 left-1/2">
        ...
        <p class="font-digital-regular text-red-600 text-3xl">Ezin izan duzu energia-sistemak berrezartu. <br>Denbora bukatu zaizu eta ezin izan zara bizirik mantendu.</p>
