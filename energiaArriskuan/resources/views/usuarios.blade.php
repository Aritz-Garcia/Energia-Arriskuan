                ...
                <tbody>
                    ...
                    @foreach ($users as $usuario)
                        <tr class="atzekaldeko-kolore-oinarria border border-kolore-nagusia">
                            ...
                            <th scope="row"
                                class="flex flex-col sm:flex-row items-center px-6 py-4 testu-kolore-nagusia">
                            ...
                            <td class="px-6 py-4 text-base border border-kolore-nagusia hidden sm:table-cell">
                                {{ $usuario->email }}</td>
                            <td class="py-4 pl-16 border border-kolore-nagusia">
                                <a href="{{ route('profile.index', $usuario->id) }}"><img class="h-10"
                                        src="{{ asset('images/ver.png') }}"></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
